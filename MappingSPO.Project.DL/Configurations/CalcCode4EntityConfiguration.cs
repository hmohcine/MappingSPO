...
{
    public class CalcCode4EntityConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<CalcCode4Entity>
    {
        public CalcCode4EntityConfiguration()
            : this("Project")
        {
        }

        public CalcCode4EntityConfiguration(string schema)
        {
            ToTable("tCalcCode4", schema);
