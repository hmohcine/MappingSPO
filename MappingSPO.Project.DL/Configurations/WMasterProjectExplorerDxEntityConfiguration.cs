...
{
    public class WMasterProjectExplorerDxEntityConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<WMasterProjectExplorerDxEntity>
    {
        public WMasterProjectExplorerDxEntityConfiguration()
            : this("dbo")
        {
        }

        public WMasterProjectExplorerDxEntityConfiguration(string schema)
        {
            ToTable("vwMasterProjectExplorerDX", schema);
