...
{
    public partial class WProjectExplorerDxEntity
    {
		public WProjectExplorerDxEntity()
        {
        ...
        public double? BudgetViaCalc { get; set; }
        public double? TvpViaCalc { get; set; }
        public double? BudgetViaWerf { get; set; }
        public double? TvpViaWerf { get; set; }
        ...
        public double? ProjectTvp { get; set; }
