...
namespace MappingSPO.Entities
{
    public partial class SysWerfParaEntity
    {
        ...
        public RelActiviteitEntity RelActiviteit_DefaultInkoopCat { get; set; }
        public RelActiviteitEntity RelActiviteit_DefaultVerkoopCat { get; set; }
        public RelActiviteitEntity RelActiviteit_DefaultVerkoopCatRegie { get; set; }
        public RelationEntity Relation { get; set; }
        public VatEntity Vat { get; set; }
        public VatRegimeEntity VatRegime { get; set; }
        public WerfTypeEntity WerfType_ContractOaDefaultType { get; set; }
        public WerfTypeEntity WerfType_WerfDefaultType { get; set; }
